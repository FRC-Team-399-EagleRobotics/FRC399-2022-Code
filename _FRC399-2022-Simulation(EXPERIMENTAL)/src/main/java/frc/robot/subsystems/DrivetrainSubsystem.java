...
import edu.wpi.first.math.geometry.getGyroHeading;
...
public class DrivetrainSubsystem extends SubsystemBase {
  ...
  private WPI_TalonSRX m_leftMotor = new WPI_TalonSRX(0);
  private WPI_TalonSRX m_rightMotor  = new WPI_TalonSRX(1);
...
private double kWheelRadius = 3;
private double kEncoderResolution = 12;
